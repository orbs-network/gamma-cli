...
var uint256Array = []*big.Int{big.NewInt(1), big.NewInt(4194304)}
var stringArray = []string{"picture", "yourself", "in", "a", "boat", "on", "a", "river"}
var bytesArray = [][]byte{{0x11, 0x12}, {0xa, 0xb, 0xc, 0xd}, {0x1, 0x2}}
var bytes20Array = [][20]byte{{0xaa, 0xbb}, {0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x01,
...
var bytes32Array = [][32]byte{{0x11, 0x12}, {0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x04,
	0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x01, 0x02, 0x03, 0x04}, {0xa, 0xb, 0xc, 0xd}}
